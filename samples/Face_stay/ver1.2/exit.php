<?php
    ...
    foreach($images as $file){
        if(is_file($file)){
            ...
            $imgline = $imgline . "<a data-target=\"enter_$filename\" class=\"modal-open\"><img src=\"$enterfile\"></a><br>\n";
            $imgline = $imgline . "<font size=\"5\">&dArr;</font><br><br>\n";
            $imgline = $imgline . "<a data-target=\"exit_$filename\" class=\"modal-open\"><img src=\"$file\"></a>\n";
